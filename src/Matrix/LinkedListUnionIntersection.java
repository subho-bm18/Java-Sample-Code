...
{ 
    ...
    { 
    	LinkedListUnionIntersection llist1 = new LinkedListUnionIntersection(); 
    	LinkedListUnionIntersection llist2 = new LinkedListUnionIntersection(); 
    	LinkedListUnionIntersection unin = new LinkedListUnionIntersection(); 
    	LinkedListUnionIntersection intersecn = new LinkedListUnionIntersection(); 
